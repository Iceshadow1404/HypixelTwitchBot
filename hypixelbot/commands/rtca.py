...
from hypixelbot.calculations import calculate_class_level, _get_xp_for_target_level
from hypixelbot.commands.mayor import MayorCommand  # Importiere die MayorCommand Klasse
